...
function playAgain(){  
     ...
     for(var k =0; k<span.length; k++){  
          span[k].parentNode.className= span[k].parentNode.className.replace("activeBox", "");//remover a classe activebox; você pode usar classlist.remove, mas ele não suporta todos os navegadores  
     }  
} 
...
function gameOver(a){  
     var gameOverAlertElement = "<b>GAME OVER</b><br><br> Player " + span[a].dataset.player.toUpperCase() + ' Ganhou !!! <br><br>' + restartButton  
